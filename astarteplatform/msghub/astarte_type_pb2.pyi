...
class AstarteDataTypeIndividual(_message.Message):
    __slots__ = ["astarte_binary_blob", "astarte_binary_blob_array", "astarte_boolean", "astarte_boolean_array", "astarte_date_time", "astarte_date_time_array", "astarte_double", "astarte_double_array", "astarte_integer", "astarte_integer_array", "astarte_long_integer", "astarte_long_integer_array", "astarte_string", "astarte_string_array"]
